...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"/>
		...
		<%--Load course of this user to the JSP --%>
		<script>
		window.onload = $.get("ListUserCourse", function(){
...
<% User user = (User)session.getAttribute("user"); 
	...
	List<Course> courseList = (ArrayList<Course>)request.getSession().getAttribute("courseList");
	//String courseName = (String)courseList.get(0).getCourseName();
%>
<p align="center">Current user: <%=userName %></p>
<h1 align="center"><font><strong>My Current Courses </strong></font></h1>
...
if(courseList != null) {
	for(Course course : courseList)
	{
		...
		<td><%=course.getQuiz() %></td>
		<td><%=course.getHomework() %></td>
		<td><%=course.getReadingQuiz() %></td>
		<td><%=course.getFinalDate() %></td>

		<td>
			<form action="view" method="post">
			<input type="hidden" class="button" name="courseName" value="<%=course.getCourseName() %>" />
